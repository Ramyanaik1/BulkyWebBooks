...
namespace BulkyWebBooks.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
         ...
         .Select(x => new SelectListItem { Text = x.Name, Value = x.CompanyId.ToString() })
         .ToList()
            };
            ReturnUrl = returnUrl;
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.CompanyId = Input.CompanyId ?? null;
