...
namespace BulkyWebBooks.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult GetAll(string status)
        {
            ...
            {
                case "pending":
                    orderHeaders = orderHeaders.Where(u => u.OrderStatus == "Pending").ToList();
                    break;
                case "inprocess":
                    orderHeaders = orderHeaders.Where(u => u.OrderStatus == "In Process").ToList();
                    break;
                case "completed":
                    orderHeaders = orderHeaders.Where(u => u.OrderStatus == "Completed").ToList();
                    break;
                case "approved":
                    orderHeaders = orderHeaders.Where(u => u.OrderStatus == "Approved").ToList();
                    break;
                default:
                    break;
            }
        ...
        #region Commented to implement Payment method
        //[ActionName("Details")]
        //[HttpPost]
